(() => {
  ...
  var handler = (ns) => ({ get: (_, name) => tag.bind(void 0, ns, name) });
  ...
  var _tags = _tagsNS("");
  var tags2 = new Proxy(tagsNS2, { get: (_, name) => _tags[name] });
  var hydrate2 = (dom, f) => {
  ...
  var van_debug_default = { add: add2, tags: tags2, state: state2, derive: derive2, hydrate: hydrate2, startCapturingErrors, stopCapturingErrors, get capturedErrors() {
