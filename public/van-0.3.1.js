...
let [isArr, doc] = [Array.isArray, document]

let strToTextDom = dom => typeof dom !== "object" ? doc.createTextNode(dom) : dom

export let add = (dom, ...children) => {
  for (let child of children)
    isArr(child) ? add(dom, ...child) : dom.appendChild(strToTextDom(child))
}
