...
export const tag = (name, ...args) => {
  const [props, children] =
    args.length === 0 || typeof args[0] === "string" || args[0] instanceof Node || Array.isArray(args[0]) ?
...
const strToTextDom = dom => typeof dom === "string" ? document.createTextNode(dom) : dom
