...
export interface DerivedProp {
  readonly deps: StateView<unknown>[]
  readonly f: (...args: any[]) => PropValue
}
...
export type ChildDom = Primitive | Node | StateView<Primitive | null | undefined> | ChildDom[]

export type TagFunc<Result> = (first?: Props | ChildDom, ...rest: ChildDom[]) => Result
...
export type Van = {
  ...
  readonly add: (dom: Element, ...children: ChildDom[]) => Element
  readonly tags: Tags
