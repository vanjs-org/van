...
cp dist/van-x.nomodule.js ../../vanjs-org.github.io/code/van-x-$VER.nomodule.js
cp dist/van-x.nomodule.min.js ../../vanjs-org.github.io/code/van-x-$VER.nomodule.min.js
